  ...
  n.prototype = {
    utils: {
      ...
      var l = e("<input/>", {"class": s.classes.input, "readonly": s.utils.isMobile()}),
        ...
        o = e("<span/>", {"class": s.classes.label}), r = s.$element.wrap("<div/>").parent().append(a.prepend(o), i, l),
      ...
      var t = this, s = t.$element.children(), l = t.$element.find("option"), i = l.filter(":selected"), n = l.index(i),
        a = 0, o = t.state.multiple ? [] : 0;
      ...
      t.elements.outerWrapper.on("mouseenter.sl mouseleave.sl", function (s) {
        ...
        clearTimeout(t.resetStr), t.resetStr = setTimeout(function () {
          ...
          if (!s.disabled) {
            ...
            if (s.alt) for (var i = s.alt.split("|"), n = 0; n < i.length && i[n]; n++) if (l.test(i[n].trim())) return t.highlight(e), !1
          }
        })
      })), t.$li.on({
      ...
      var s = this, l = t.which, i = s.options.keys, n = e.inArray(l, i.previous) > -1, a = e.inArray(l, i.next) > -1,
        o = e.inArray(l, i.select) > -1, r = e.inArray(l, i.open) > -1, u = s.state.highlightedIdx,
      ...
      if (!0 === e.options.forceRenderAbove) e.elements.outerWrapper.addClass(e.classes.above); else if (!0 === e.options.forceRenderBelow) e.elements.outerWrapper.addClass(e.classes.below); else {
        var t = s.scrollTop(), l = s.height(), i = e.elements.outerWrapper.offset().top,
          n = e.elements.outerWrapper.outerHeight(), a = i + n + e.itemsHeight <= t + l, o = i - e.itemsHeight > t,
          r = !a && o, u = !r;
